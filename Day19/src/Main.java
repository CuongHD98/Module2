...
public class Main {
    ...
    public static String inputString(String typeInputString, String regex) {
        String element;
        while (true) {
    ...
    public static void main(String[] args) {
        String username = inputString("username", Validate.UserName_PATTERN);
...
class Validate {
    ...
    public static final String INT_PATTERN = "^\\d+$";//15
